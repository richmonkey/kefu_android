...
import com.beetle.bauhinia.db.MessageDB;
import com.beetle.bauhinia.db.MessageFlag;
import com.beetle.bauhinia.db.MessageIterator;
import com.beetle.bauhinia.db.ReverseFile;
 ...
 */
public class CustomerSupportMessageDB extends MessageDB {
    private class CustomerMessageIterator implements MessageIterator {
        ...
        public IMessage next() {
            ...
            return CustomerSupportMessageDB.readMessage(this.revFile);
        }
    }
        ...
        public Conversation next() {
            ...
            for (; index < files.length; index++) {
                ...
                try {
                    ...
                    long appID = Long.parseLong(array[0]);
                    long uid = Long.parseLong(array[1]);

                    IMessage msg = getLastMessage(file);
                    if (msg == null) {
                        continue;
                    }
                    CustomerConversation conv = new CustomerConversation();
                    conv.type = this.type;
                    conv.cid = uid;
                    conv.customerAppID = appID;
                    conv.customerID = uid;
                    conv.message = msg;
                    return conv;
    ...
    private static CustomerSupportMessageDB instance = new CustomerSupportMessageDB();

    public static CustomerSupportMessageDB getInstance() {
        return instance;
    }
    ...
    private String fileName(long uid, long appid) {
        return "" + appid + "_" + uid;
    }
    ...
    public boolean insertMessage(IMessage msg) {
        try {
            ...
            File file = new File(this.dir, fileName(cm.customerID, cm.customerAppID));
    ...
    public boolean acknowledgeMessage(int msgLocalID, long uid, long appID) {
        try {
            File file = new File(this.dir, fileName(uid, appID));
            RandomAccessFile f = new RandomAccessFile(file, "rw");
    ...
    public boolean markMessageFailure(int msgLocalID, long uid, long appID) {
        try {
            File file = new File(this.dir, fileName(uid, appID));
            RandomAccessFile f = new RandomAccessFile(file, "rw");
    ...
    public boolean eraseMessageFailure(int msgLocalID, long uid, long appID) {
        try {
            File file = new File(this.dir, fileName(uid, appID));
            RandomAccessFile f = new RandomAccessFile(file, "rw");
    ...
    public boolean removeMessage(int msgLocalID, long uid, long appID) {
        try {
            File file = new File(this.dir, fileName(uid, appID));
            RandomAccessFile f = new RandomAccessFile(file, "rw");
    ...
    public boolean clearCoversation(long uid, long appID) {
        try {
            File file = new File(this.dir, fileName(uid, appID));
            return file.delete();
        } catch (Exception e) {
    ...
    public MessageIterator newMessageIterator(long uid, long appID) {
        try {
            File file = new File(this.dir, fileName(uid, appID));
            RandomAccessFile f = new RandomAccessFile(file, "r");
    ...
    public MessageIterator newMessageIterator(long uid, long appID, int firstMsgID) {
        try {
            File file = new File(this.dir, fileName(uid, appID));
            RandomAccessFile f = new RandomAccessFile(file, "r");
